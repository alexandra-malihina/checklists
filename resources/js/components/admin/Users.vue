<template>
    <div class="d-flex flex-column">
        ...
        >
            <div
                class="d-flex p-2 justify-content-between align-items-baseline"
            >
            ...
            <div
                class="p-3 accordion w-100 collapse"
                :id="'check_' + user.id"
                v-if="can_view_checklists"
            >
                <check-list
...
export default {
    ...
    methods: {
        ...
        checkListMax(index) {
            ...
            if (
                this.users[index].max_check_lists_count <
                this.users[index].current_check_lists_count
            ) {
                this.users[index].max_check_lists_count =
                    this.users[index].current_check_lists_count;
            }
