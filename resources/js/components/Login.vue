<template>
    <div class="bg-white border p-5 mx-auto my-5 col-12 col-md-6 col-lg-4 rounded">
		<label>Email</label>
        <input
            v-model="email"
            type="email"
        ...
        />
        <input @click.prevent="login" type="submit" value="Войти" class="btn btn-primary mb-3" :class="{disabled: (password.length === 0 || email.length === 0)}"/>
