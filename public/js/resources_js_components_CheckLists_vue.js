  ...
  methods: {
    getItems: function getItems() {
      ...
      axios.get("/api/check-lists/" + this.check_list_info.id + '/items').then(function (r) {
        ...
        _this.$emit('set-loading', false); // let data = r.data
        // this.$emit('set-message', data.message, data.error)


        _this.items = r.data;
        _this.is_load_items = true;
  ...
  methods: {
    changeItemDone: function changeItemDone() {
      ...
      axios.put("/api/check-lists/" + this.item.check_list_id + '/items/' + this.item.id, {
        ...
        _this.items = r.data;
        _this.is_load_items = true; // console.log(this.items)
      });
    }
  }
});
...
var render = function render() {
  ...
  }, [_vm._v("\n\t\t\t\t" + _vm._s(_vm.user.current_check_lists_count) + " / " + _vm._s(_vm.user.max_check_lists_count) + "\n\t\t\t\t")])]), _vm._v(" "), _c("div", {
